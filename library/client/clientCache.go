...
type ClientCacheStorage interface {
	FindByID(ctx *gin.Context, clientCacheID int) (*ClientCache, *types.Error)
	FindByURL(ctx *gin.Context, url string, method string, bufferedTime *int) (*ClientCache, *types.Error)
	FindAll(ctx *gin.Context, params *FindAllClientCachesParams) ([]*ClientCache, *types.Error)
	Insert(ctx *gin.Context, clientCache *ClientCache) (*ClientCache, *types.Error)
	Update(ctx *gin.Context, clientCache *ClientCache) (*ClientCache, *types.Error)
	Delete(ctx *gin.Context, clientCache *ClientCache) *types.Error
}
...
type ClientCacheServiceInterface interface {
	CountClientCache(ctx *gin.Context, params *FindAllClientCachesParams) (int, *types.Error)
	GetClientCache(ctx *gin.Context, clientCacheID int) (*ClientCache, *types.Error)
	ListClientCaches(ctx *gin.Context, params *FindAllClientCachesParams) ([]*ClientCache, *types.Error)
	CreateClientCache(ctx *gin.Context, params *CreateClientCacheParams) (*ClientCache, *types.Error)
	UpdateClientCache(ctx *gin.Context, clientCache int, params *UpdateClientCacheParams) (*ClientCache, *types.Error)
	DeleteClientCache(ctx *gin.Context, clientCacheID int) *types.Error
	IsClientNeedToBeCache(ctx *gin.Context, url string, method string) (bool, *types.Error)
	GetClientCacheByURL(ctx *gin.Context, params *GetClientCacheByURLParams) (*ClientCache, *types.Error)
}
...
func (s *ClientCacheService) IsClientNeedToBeCache(ctx *gin.Context, url string, method string) (bool, *types.Error) {
...
func (s *ClientCacheService) GetClientCacheByURL(ctx *gin.Context, params *GetClientCacheByURLParams) (*ClientCache, *types.Error) {
	if params.IsActive {
...
func (s *ClientCacheService) GetClientCache(ctx *gin.Context, clientCacheID int) (*ClientCache, *types.Error) {
...
func (s *ClientCacheService) CountClientCache(ctx *gin.Context, params *FindAllClientCachesParams) (int, *types.Error) {
	params.Limit = 0
	params.Page = 0
...
func (s *ClientCacheService) ListClientCaches(ctx *gin.Context, params *FindAllClientCachesParams) ([]*ClientCache, *types.Error) {
	clientCaches, err := s.clientCacheRepository.FindAll(ctx, params)
	if err != nil {
...
func (s *ClientCacheService) CreateClientCache(ctx *gin.Context, params *CreateClientCacheParams) (*ClientCache, *types.Error) {
...
func (s *ClientCacheService) UpdateClientCache(ctx *gin.Context, clientCacheID int, params *UpdateClientCacheParams) (*ClientCache, *types.Error) {
	validate := validator.New()
	validate.RegisterTagNameFunc(func(fld reflect.StructField) string {
		name := strings.SplitN(fld.Tag.Get("json"), ",", 2)[0]
		if name == "-" {
...
func (s *ClientCacheService) DeleteClientCache(ctx *gin.Context, clientCacheID int) *types.Error {
	clientCache, err := s.clientCacheRepository.FindByID(ctx, clientCacheID)
	if err != nil {
