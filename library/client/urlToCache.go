...
type URLToCacheStorage interface {
	FindByID(ctx *gin.Context, urlToCacheID int) (*URLToCache, *types.Error)
	FindByURL(ctx *gin.Context, url string, method string) (*URLToCache, *types.Error)
	FindAll(ctx *gin.Context, params *FindAllURLToCachesParams) ([]*URLToCache, *types.Error)
	Insert(ctx *gin.Context, urlToCache *URLToCache) (*URLToCache, *types.Error)
	Update(ctx *gin.Context, urlToCache *URLToCache) (*URLToCache, *types.Error)
	Delete(ctx *gin.Context, urlToCache *URLToCache) *types.Error
}
...
type URLToCacheServiceInterface interface {
	CountURLToCache(ctx *gin.Context, params *FindAllURLToCachesParams) (int, *types.Error)
	GetURLToCache(ctx *gin.Context, couponID int) (*URLToCache, *types.Error)
	GetURLToCacheByURL(ctx *gin.Context, url string, method string) (*URLToCache, *types.Error)
	ListURLToCaches(ctx *gin.Context, params *FindAllURLToCachesParams) ([]*URLToCache, *types.Error)
	CreateURLToCache(ctx *gin.Context, params *CreateURLToCacheParams) (*URLToCache, *types.Error)
	UpdateURLToCache(ctx *gin.Context, urlToCache int, params *UpdateURLToCacheParams) (*URLToCache, *types.Error)
	DeleteURLToCache(ctx *gin.Context, urlToCacheID int) *types.Error
}
...
func (s *URLToCacheService) GetURLToCacheByURL(ctx *gin.Context, url string, method string) (*URLToCache, *types.Error) {
...
func (s *URLToCacheService) GetURLToCache(ctx *gin.Context, urlToCacheID int) (*URLToCache, *types.Error) {
...
func (s *URLToCacheService) CountURLToCache(ctx *gin.Context, params *FindAllURLToCachesParams) (int, *types.Error) {
	params.Limit = 0
	params.Page = 0
...
func (s *URLToCacheService) ListURLToCaches(ctx *gin.Context, params *FindAllURLToCachesParams) ([]*URLToCache, *types.Error) {
	urlToCaches, err := s.urlToCacheRepository.FindAll(ctx, params)
	if err != nil {
...
func (s *URLToCacheService) CreateURLToCache(ctx *gin.Context, params *CreateURLToCacheParams) (*URLToCache, *types.Error) {
...
func (s *URLToCacheService) UpdateURLToCache(ctx *gin.Context, urlToCacheID int, params *UpdateURLToCacheParams) (*URLToCache, *types.Error) {
	validate := validator.New()
	validate.RegisterTagNameFunc(func(fld reflect.StructField) string {
		name := strings.SplitN(fld.Tag.Get("json"), ",", 2)[0]
		if name == "-" {
...
func (s *URLToCacheService) DeleteURLToCache(ctx *gin.Context, urlToCacheID int) *types.Error {
	urlToCache, err := s.urlToCacheRepository.FindByID(ctx, urlToCacheID)
	if err != nil {
